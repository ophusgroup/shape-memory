...
This pseudo-2D cell has nine grains. Press play and watch the transformation sweep across the microstructure grain by grain (red austenite to cyan martensite), then reverse on unloading.
